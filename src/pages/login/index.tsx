...
const Login = () => {
    return <section style={{ display: 'flex', flex: 1, }}>
        ...
        <section
            ...
            >
            <Typography variant="logintitle" gutterBottom>
                Iniciar sesión
            </Typography>
            ...
            <section style={{ display: 'flex', alignSelf: 'center', marginBottom: '16px' }}>
                <FormControlLabel control={<Checkbox defaultChecked />} label="Recordar usuario y contraseña" />
            </section>
            <Button variant="contained" color="primary" className="button" style={{ marginBottom: '16px' }}>
                Iniciar sesión
            </Button>
